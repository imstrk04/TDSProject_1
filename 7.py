...
# Debugging: Print the collected stats for each language
print("Language statistics:", dict(language_stats))
...
if average_stars_per_language:
    ...
    print("Average stars:", average_stars_per_language[most_popular_language])
else:
